        ...
        <ul className="flex md:w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-slate-200 sm:w-[initial] sm:flex-nowrap sm:gap-5">
          {links.map((link) => (
            ...
            >
              <Link
                prefetch={true}
                className="flex w-full items-center justify-center px-2 py-2 hover:text-slate-400 transition dark:text-gray-500 dark:hover:text-gray-300 font-semibold text-lg"
                href={link.href}
              >
                <div
