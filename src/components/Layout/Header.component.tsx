...
const Header = () => {
  ...
  return (
    <header className="z-[999] relative">
      <MotionDiv
        className="w-full max-w-[380px] md:max-w-[36rem] bg-slate-800 bg-opacity-80 fixed top-0 left-1/2 h-[4.5rem] shadow rounded-none shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] md:w-[36rem] sm:rounded-full mr-6 md:mr-0"
