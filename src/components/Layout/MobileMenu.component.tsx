      ...
      <AnimatePresence>
        {isExpanded && (
          <m.div
            ...
            data-cy="mobile-menu"
            className="fixed top-0 -right-[50vw] w-[150vw] h-[calc(100vh+20px)] bg-gray-800 flex items-center justify-center z-40 -mt-4 overflow-y-auto scrollbar-gutter-stable"
            initial="closed"
            animate="open"
            exit="closed"
